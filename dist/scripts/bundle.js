...
var _libScrollJs = require('./lib/scroll.js');

var _libScrollJs2 = _interopRequireDefault(_libScrollJs);

(0, _libScrollJs2['default'])('#projects--link', '#projects');
(0, _libScrollJs2['default'])('#resume--link', '#resume');

},{"./lib/scroll.js":3}],3:[function(require,module,exports){
'use strict';
...
function scroll(link, target) {
  ...
  var link = (0, _utilJs.$)(link);
  var target = (0, _utilJs.$)(target);

  console.log(link, target);

  link.on('click', function (e) {
    e.preventDefault();
    var offset = (0, _utilJs.getOffset)(target);
    var opts = { scrollTo: { y: offset } };
    _gsap2['default'].to(window, 0.5, opts);
    return false;
  });
}
...
},{"./util.js":4,"gsap":1}],4:[function(require,module,exports){
"use strict";
